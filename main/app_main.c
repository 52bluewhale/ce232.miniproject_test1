...
#define flespi_token "geKDPveohMuVnvnl4UYc5JnY5WawCVnZmL3Jf0ufuFaM1NAyvIBYWMgV0eI2HtXw"
#define buffer_size 200

char *topic_publish = "topic/Test_Test_Test";
...
static void mqtt_app_start(void)
{
    esp_mqtt_client_config_t mqtt_cfg = {
        ...
        .credentials.username = flespi_token,
    };
